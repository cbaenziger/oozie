...
public class TestGitActionExecutor extends ActionExecutorTestCase{
    ...
    public void testSetupMethods() throws Exception {
        ...
        Element actionXml = XmlUtils.parseXml("<git>" +
                ...
                "<destination-uri>repoDir</destination-uri>" +
                "</git>");
        ...
        String oozieActionGitRootLogger = "oozie.action.git" + LauncherMapper.ROOT_LOGGER_LEVEL;
        conf.set(oozieActionGitRootLogger, "DEBUG");
        ae.setRootLoggerLevel(conf);
        assertEquals("DEBUG", conf.get(oozieActionGitRootLogger));

        ae.setupActionConf(conf, context, actionXml, getFsTestCaseDir());
        assertEquals(repoUrl, conf.get(GitActionExecutor.GIT_URI));
        assertEquals("repoDir", conf.get(GitActionExecutor.DESTINATION_URI));
    }
